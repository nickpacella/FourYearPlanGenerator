...
async function scrapeCourses() {
  try {
    ...
    await page.goto('https://www.vanderbilt.edu/catalogs/kuali/undergraduate-24-25.php#/content/66577a6007c565001c90c72e', {
    ...
    await page.waitForFunction(
      () => document.body.innerText.includes("Specimen Curriculum for Electrical and Computer Engineering"),
      { timeout: 60000 }
    );
