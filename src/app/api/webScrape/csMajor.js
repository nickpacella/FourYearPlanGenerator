...
async function scrapeCourses() {
  try {
    ...
    await page.goto('https://www.vanderbilt.edu/catalogs/kuali/undergraduate-24-25.php#/content/66577a6007c565001c90c72d', {
    ...
    await page.waitForFunction(
      () => document.body.innerText.includes("Specimen Curriculum for Computer Science"),
      { timeout: 60000 }
    );
